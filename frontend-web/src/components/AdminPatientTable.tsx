...
const AdminPatientTable: React.FC<AdminPatientTableProps> = ({
    patients,
    selectedId,
    onSelect,
    onView,
        ...
        <div className="questionnaire-table-container">
                    ...
                    {patients.map((p) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <td>{p.nomePsicologo || 'Non assegnato'}</td>
            ...
            {patients.length === 0 && (
                <div className="unified-empty-state">
                    ...
                    <h3 className="unified-empty-title">Nessun Paziente</h3>
                    <p className="unified-empty-message">
                        Non sono stati trovati pazienti con i criteri selezionati.
                    </p>
                </div>
            )}
        </div>
